...
<body>  
    <div class="grid grid-cols-12">
        {{-- sidebar --}}
        <div class="col-span-2 bg-hijau-tua text-cream h-screen px-8 py-12 relative">
            ...
            <div class="space-y-6 pt-6">
                ...
                <a href="{{ route('log') }}" class="{{ (Route::is('log') ? 'order-l-2 -ml-8 pl-8' : 'opacity-80') }} hover:opacity-100 flex space-x-4 py-0.5">
                    <div class="h-6 w-6 grid justify-items-center">
                        @include('icons.note')
                    </div>
                    <span>Log</span>
    ...
    <script>
        ...
        var m = d.getMinutes();
        var h = d.getHours();
        var day = d.toLocaleDateString("id",{weekday:"long"});
        var date = d.getDate();
        var month = d.toLocaleString("id", { month: "short" });
